...
import { CaretRight, FileArrowDown, Image, Lightning, TelegramLogo } from "phosphor-react";
    ...
    <div className="flex-1 bg-zinc-950 mt-4 ">
      ...
      <div className="p-8 max-w-[1250px] mx-auto">
        ...
        <div className="gap-4 mt-20 grid grid-cols-2 xs:grid-cols-1">
          <a href="https://t.me/serignis" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <div className="py-6 leading-relaxed ">
              ...
              <p className="text-sm text-gray-200 mt-2">
                Participe da nossa comunidade no telegram para se manter sempre atualizado.
              </p>
            </div>
